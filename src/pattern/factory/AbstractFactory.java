...
class Tea implements HotDrink {
    ...
    @Override
    public void consume() {
        System.out.println("This tee is delicious");
    }
}
...
class HotDrinkMachine {
    ...
    public HotDrinkMachine() throws Exception {
        ...
        for(Class<? extends HotDrinkFactory> clazz : types){
            Pair p = new Pair<>(clazz.getSimpleName().replace("Factory", ""),
                    clazz.getDeclaredConstructor().newInstance());
            namedFactories.add(p);
        }
    }
